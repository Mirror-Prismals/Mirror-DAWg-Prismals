...
const Color bgColor = { 0.95f, 0.95f, 0.95f, 1.0f };
const Color leftCol = { 0.85f, 0.85f, 0.85f, 1.0f };
const Color rightCol = { 0.86f, 0.86f, 0.86f, 1.0f };
const Color topCol = { 0.87f, 0.87f, 0.87f, 1.0f };
const Color bottomCol = { 0.88f, 0.88f, 0.88f, 1.0f };

// Drawing colors (opaque)
const Color leftDrawCol = { leftCol.r, leftCol.g, leftCol.b, 1.0f };
const Color rightDrawCol = { rightCol.r, rightCol.g, rightCol.b, 1.0f };
const Color topDrawCol = { topCol.r, topCol.g, topCol.b, 1.0f };
const Color bottomDrawCol = { bottomCol.r, bottomCol.g, bottomCol.b, 1.0f };
...
// Outer Top: covers the full width and 20% of the window height.
...
// Outer Bottom: full width, 30% of window height.
...
// Outer Left: occupies 20% of the window width.
...
// Outer Right: occupies 20% of the window width.
...
// Here we override the outer panel fractions with new ones:
// Inner Top: Height = 0.4 * winHeight, full width.
// Inner Bottom: Height = 0.6 * winHeight, full width.
// Inner Left: Width = 0.4 * winWidth, full height.
// Inner Right: Width = 0.4 * winWidth, full height.
// Geometry Functions for Inner Panels (Modified for Reduced Top/Bottom Height)
// Inner Top: height reduced to 30% of winHeight (unchanged from previous inner top)
...
// Inner Bottom: height increased to 40% of winHeight
...
// Inner Left: width reduced to 35% of winWidth
...
// Inner Right: width reduced to 35% of winWidth
...
// ----------------------------------------------------
// Skeuomorphic Drawing Function (unchanged)
...
// ----------------------------------------------------
// Update Inner Panel Animations and Hold Timers (WASD)
void updateInnerAnimations(double dt) {
    if (wHoldActive) {
        wHoldTimer += dt;
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(winWidth, winHeight, "Tunnel UI Demo (Modified Inner Panels)", nullptr, nullptr);
