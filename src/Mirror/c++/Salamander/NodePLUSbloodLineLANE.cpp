...
// A subtle vertical and horizontal wiggle is added to each vertex for a dynamic effect.
static void drawWaveform(float windowWidth, float windowHeight) {
    ...
    for (size_t i = 0; i < audioData.size(); i++) {
        ...
        // Add a subtle vertical wiggle to each vertex.
        ...
        // Add a subtle horizontal wiggle to each vertex.
